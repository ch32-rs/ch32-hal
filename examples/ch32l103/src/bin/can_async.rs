...
use ch32_hal::{self as hal, peripherals};
...
bind_interrupts!(
    struct Irqs {
        USB_HP_CAN_TX => hal::can::TransmitInterruptHandler<peripherals::CAN1>;
        USB_LP_CAN_RX0 => hal::can::ReceiveInterruptHandler<peripherals::CAN1>;
    }
);
...
async fn main(_spawner: Spawner) -> ! {
    ...
    loop {
        ...
        let _ = can.transmit(&frame).await;
